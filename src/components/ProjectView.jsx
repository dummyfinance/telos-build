...
function ProjectView(props) {
  ...
  function getCategoryFromCode(val) {
    let categoryCode = ["Defi", "NFT", "Social", "Gaming", "Other"];
  ...
  // claim funds by calling function in the smart contract
      ...
      <div className="projectContainer">
        ...
        <div className="projectTopContainer">
          ...
          <div className="projectInformationContainer">
            ...
            <div className="fundingValue">
              <h2>{projectDetails.amountRaised / PRECISION} TELOS</h2>
            </div>
            <p className="goalValueContainer">
              Amount Funded of{" "}
              <span className="goalValue">
                {projectDetails.fundingGoal / PRECISION} TELOS
              </span>{" "}
              goal
            </p>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" className="stroke-current flex-shrink-0 w-6 h-6"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
              <span style={{left: "0px !important"}}>{!isOver ? timerString : "Funding duration has ended."}</span>
            </div>
            {!isOver && (
              <p className="afterRemainingDaysContainer">
                time remaining for funding
              </p>
            )}
            {!isOver ? (!isOwner() && (
              <div className="supportButtonContainer">
                <label for="my-modal-4" className="supportButton"
            ...
            ) : (projectDetails.claimedAmount ? (<h2 style={ { color: '#1AD6FF', margin: '10px' } }>CONGRATULATIONS! Funds claimed.</h2>) : '')) : (
            ...
            ) : (projectDetails.refundClaimed[getContributorIndex()] ? (<h2 style={{ color: '#1AD6FF', margin: '10px' }}>Refund Claimed Succesfully.</h2>) : ''))}
            {modalShow && (
              <PaymentModal
        ...
        <div className="projectBottomContainer">
          <div className="aboutContainer">
            <h1 className="about">Project Description</h1>
        ...
        <div className="contributors">
          <div className="tableRow header">
            <div className="item border" style={{width: "80px"}}>ID</div>
